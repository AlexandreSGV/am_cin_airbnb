...
if(sessions == True):
	pickle.dump(model, open('../output/model_users_sessions.p', 'wb'))
	pickle.dump(le, open('../output/labelencoder_users_sessions.p', 'wb'))

if(sessions == False):
	pickle.dump(model, open('../output/model_users.p', 'wb'))
	pickle.dump(le, open('../output/labelencoder_users.p', 'wb'))
